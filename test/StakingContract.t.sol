...
contract StakingContractTest is Test {
    ...
    function setUp() public {
        ...
        stakingContract = new StakingContract(basicToken, 1e18 /* Reward Rate */, currentTime /* Emission start */, 365 days /* Emission Duration */);
        basicToken.transfer(address(stakingContract), 100_000_000 * 1e18);
    ...
    function testUnstakeStopsRewardsAccumulation() public {
        ...
        uint256 minStakeTime = stakingContract.minStakeTime();
        ...
        // Initiate unstake
        vm.startPrank(staker1);
        vm.warp(block.timestamp + minStakeTime);
...
function testCompleteUnstakeWithEmissionsFeesWithdraw() public {
    ...
    function test_notEnoughRewardsToken() public {
        uint256 minStakeTime = stakingContract.minStakeTime();
        deal(address(basicToken), address(stakingContract), 7_000_000e18);
